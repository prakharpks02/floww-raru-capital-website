$(function ($) {
  ...
  document.getElementById('contact_form_submit').addEventListener('submit', function (event) {
    ...
    // Now you can send the data to the API (this is an example with fetch)
    fetch('https://service-node.gofloww.co/api/contactus', {
        method: 'POST',
        headers: {
